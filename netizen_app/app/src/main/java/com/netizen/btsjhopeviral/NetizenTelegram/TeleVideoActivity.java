...
public class TeleVideoActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    MediaPlayer mp;
    Camera camera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.call_activity_tele_video_call);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TeleVideoActivity.this, Netizencall_MainActivity.class);
        ...
        terima.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                surfaceHolder.addCallback(TeleVideoActivity.this);
                surfaceHolder.setFormat(PixelFormat.OPAQUE);
                surfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_NORMAL);
